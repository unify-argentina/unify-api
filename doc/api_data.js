define({ "api": [
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8080/api/user/:user_id/email/draft"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8080/api/user/:user_id/email/inbox"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8080/api/user/:user_id/email/sent"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8080/api/user/:user_id/email/trash"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:8080/api/user/:user_id/email"
      }
    ]
  },
  {
    ...
    "title": "Marcar como leído un email",
    "group": "Email",
    "header": {
      "fields": {
        "Header": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "email_id",
            "description": "<p>Id del email a marcar como leído</p> "
          }
        ]
      }
    },
    ...
    "filename": "api/email/index.js",
    "groupTitle": "Email",
    "name": "PostApiUserUser_idEmailEmail_id",
    "sampleRequest": [
      {
