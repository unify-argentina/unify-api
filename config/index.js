...
module.exports = {
  ...
  // Media limits
  FACEBOOK_PHOTOS_MAX_MEDIA_COUNT: process.env.FACEBOOK_PHOTOS_MAX_MEDIA_COUNT || 10,
  FACEBOOK_VIDEOS_MAX_MEDIA_COUNT: process.env.FACEBOOK_VIDEOS_MAX_MEDIA_COUNT || 10,
  FACEBOOK_STATUSES_MAX_MEDIA_COUNT: process.env.FACEBOOK_STATUSES_MAX_MEDIA_COUNT || 10,
  TWITTER_MAX_MEDIA_COUNT: process.env.TWITTER_MAX_MEDIA_COUNT || 10,
  INSTAGRAM_MAX_MEDIA_COUNT: process.env.INSTAGRAM_MAX_MEDIA_COUNT || 10,
